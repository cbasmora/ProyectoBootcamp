...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 8, 'PROYECTO BOOTCAMP', 0, 1, 'C');
        ...
        $this->Cell(0, 5, 'Código: DUI-BOY-01', 0, 1, 'R');
...
// Definir los nombres
$nombres = array(
    array($data['nombreMedico'], $data['nombreSolicitante'], "Farmacia", "Servicio"),
    array('cc: ' . $data['numeroMedico'],'cc: ' .$data['numeroSolicitante']),
);
...
$this->Cell($w_firma[3], 5, 'Nombre de Recibido', 0, 1, 'C'); // Etiqueta para la cuarta firma
